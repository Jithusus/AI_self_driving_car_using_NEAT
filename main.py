...
MIN_SPEED = 5  # Minimum speed to ensure the car keeps moving
...
def run_simulation(genomes, config):
    ...
    counter = 0
    max_steps = 30 * 60  # Total number of frames (e.g., 30 FPS * 60 seconds)
    ...
    while True:
        ...
        for i, car in enumerate(cars):
            ...
            if choice == 0:
                ...
                car.speed = max(MIN_SPEED, car.speed - 1)
            else:
                car.speed += 1
        ...
        if still_alive == 0 or counter >= max_steps:
            break
